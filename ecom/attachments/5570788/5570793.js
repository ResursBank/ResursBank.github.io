...
if (typeof ResursOmni !== "function" && typeof ResursOmni === "undefined") {
    function ResursOmni() {
        ...
        var ResursOmni = {
             ...
             * @param eventHandler
             */
            setBookingCallback: function(eventHandler) {
                omniBookingCallback = eventHandler;
            },
                            ...
                            default:
                                ...
                                if (eventDataObject.eventType.indexOf("omnicheckout") > -1) {
                                    if (eventDataObject.eventType == "omnicheckout:payment-method-change") {
                                        ...
                                        if (omniDebug) { console.log("OmniJS - user-info-change"); }
                                    ...
                                    } else if (eventDataObject.eventType == "omnicheckout:booking-order") {
                                        /*
                                         * Passing order booking to a user defined callback if exists.
                                         */
                                        if (typeof omniBookingCallback === "function") {
                                            if (omniDebug) {console.log("OmniJS - booking-order event received, user defined callback is used.");}
                                            omniBookingCallback(omnidata, eventDataObject);
                                        } else if (typeof omniBookEvent === "function") {
                                            if (omniDebug) {console.log("booking-order event received, default callback is used.");}
                                             ...
                                             */
                                            if (omniDebug) { console.log("OmniJS - booking-order event received and not callbacks was found. Automatically confirming."); }
                                            postMessage({
                                                eventType: 'omnicheckout:booking-order',
                                                isOrderReady: true
                                            });
