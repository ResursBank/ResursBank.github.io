...
- [Settings](#settings)
    - [Resurs Bank API](#resurs-bank-api)
    ...
    - [Callback Settings](#callback-settings)
        ...
        - [Test last triggered at](#test-last-triggered-at)
        - [Test last received at](#test-last-received-at)
    ...
    - [Advanced Settings](#advanced-settings)
        - [General](#general)
            ...
            - [Round item tax](#round-item-tax)
        - [Onepage iFrame based Resurs Checkout](#onepage-iframe-based-resurs-checkout)
            - [Alert customers when shipping methods update](#alert-customers-when-shipping-methods-update)
        - [Two step Magento Checkout with Resurs payment methods](#two-step-magento-checkout-with-resurs-payment-methods)
            - [Swish maximum order total](#swish-maximum-order-total)
            - [Wait for fraud control](#wait-for-fraud-control)
            - [Cancel automatically](#cancel-automatically)
            - [Debit automatically](#debit-automatically)
- [Simplified Flow](#simplified-flow)
- [Resurs Bank Checkout (RCO)](#resurs-bank-checkout-rco)
- [Part Payment widget](#part-payment-widget-1)
- [Order management](#order-management-1)
    - [Payment information](#payment-information)
    - [Payment History](#payment-history)
    - [Callbacks](#callbacks)
    - [AfterShop API integration](#aftershop-api-integration)
- [Order confirmation email](#order-confirmation-email)
- [Problems, debugging and support](#problems-debugging-and-support)
    - [Orders](#orders)
    - [Discount tax](#discount-tax)
    - [Contacting the support staff](#contacting-the-support-staff)
    - [Logs](#logs)
    - [Disable unnecessary modules](#disable-unnecessary-modules)
    - [Callbacks (technical)](#callbacks-1)
    - [Payment methods (technical)](#payment-methods-1)
    - [Information to include with problem reports](#information-to-include-with-problem-reports)
